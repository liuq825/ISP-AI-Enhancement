...
`configs/train_student_public_baseline.yaml` 以官方 320 对 Medium 规模为基准，
按每源对 16 patch 要求至少 3,200 条 train/200 个 train 源配对、64 条 val/4 个
val 源配对、6 个训练物理场景、五款相机和四个 ISO 桶；当前子集会被训练前门禁拒绝。
最终商用级
